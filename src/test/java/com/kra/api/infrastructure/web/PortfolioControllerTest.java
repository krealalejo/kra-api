...
class PortfolioControllerTest {
    ...
    void listRepos_returns200() throws Exception {
        when(gitHubPortfolioClient.listPublicRepos()).thenReturn(List.of(
                new PortfolioRepoResponse("o", "n", "o/n", "d", "https://x", List.of("aws"), 3, "2023-01-01T00:00:00Z", "2024-01-01T00:00:00Z", "Backend")));
    ...
    void getRepo_returns200() throws Exception {
        PortfolioRepoResponse r = new PortfolioRepoResponse("o", "n", "o/n", "d", "https://x", List.of(), 1, "2023-01-01T00:00:00Z", "2024-01-01T00:00:00Z", "Backend");
